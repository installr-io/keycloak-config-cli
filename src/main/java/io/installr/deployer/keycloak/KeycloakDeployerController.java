...
public class KeycloakDeployerController {
    ...
    ,   @RequestPart ( value = "encoding"  , required = false ) String encoding
        ...
        return handleRequest( () -> keycloakDeployer.deploy( toDeploymentSpec( name, data, mediaType, env, encoding ) ) );
    }
    ...
    ,   @RequestPart ( value = "encoding"  , required = false ) String encoding
        ...
        return handleRequest( () -> keycloakDeployer.undeploy( toDeploymentSpec( name, data, mediaType, env, encoding ) ) );
    }
    ...
    private DeploymentSpec toDeploymentSpec(
        String name, MultipartFile data, String type, Map<String, String> env, String encoding ) {
        DeploymentSpec spec = new DeploymentSpec();
        spec.setName( name );
        spec.setData( getBytes( data ) );
        spec.setMediaType( type );
